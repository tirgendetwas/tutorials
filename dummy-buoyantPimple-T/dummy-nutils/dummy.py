...
def main():
    ...
    # preCICE setup
    interface = precice.Interface("Dummy-Temperature", "../precice-config.xml", 0, 1)
    ...
    dummy_values = np.full(vertices.shape[0], 600.0)

    # coupling data
    field_id = interface.get_data_id("Temperature", mesh_id)
    ...
    while interface.is_coupling_ongoing():
        ...
        if interface.is_write_data_required(dt):
            interface.write_block_scalar_data(field_id, vertex_ids, dummy_values)

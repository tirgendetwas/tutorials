...
def main():
    ...
    # preCICE setup
    interface = precice.Interface("Dummy-Pressure", "../precice-config.xml", 0, 1)
    ...
    dummy_values = np.full(vertices.shape[0], 50000.0)

    # coupling data
    field_id = interface.get_data_id("Pressure", mesh_id)
